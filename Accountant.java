public class Accountant extends BusinessEmployee{
    ...
    private TechnicalLead currentSupport = null;
    ...
    public void supportTeam(TechnicalLead lead) {
        this.currentSupport = lead;
        bonusBudget = (lead.getBaseSalary() + (lead.getBaseSalary()*0.10));
    }
    ...
    public String employeeStatus() {
            return this.getEmployeeID() + " " + this.getName() + " with a budget of " + this.bonusBudget + " is supporting " + currentSupport.getName();
        }
